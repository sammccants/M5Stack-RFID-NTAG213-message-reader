...
byte MFRC522::PICC_Select(
  ...
  //		Byte 6: BCC					Block Check
  //Character - XOR of bytes 2-5 		Byte 7: CRC_A 		Byte 8: CRC_A
  ...
  //uid0	uid1	uid2 						2			uid3	uid4	uid5	uid6 		10 bytes		1			CT		uid0	uid1	uid2
  //						2			CT
  //uid3	uid4	uid5 						3			uid6	uid7	uid8	uid9
...
void MFRC522::PICC_DumpMifareClassicSectorToSerial(
  ...
  // blocks 0-4 (for sectors 32-39) Each group has access bits [C1 C2 C3]. In
  // this code C1 is MSB and C3 is LSB. The four CX bits are stored together in
  // a nible cx and an inverted nible cx_.
